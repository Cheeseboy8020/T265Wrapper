...
#include <mutex>
/* Header for class org_robotroopers_wrapper_T265Camera */

#ifndef _Included_org_robotroopers_wrapper_T265Camera
#define _Included_org_robotroopers_wrapper_T265Camera
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     org_robotroopers_wrapper_T265Camera
 * Method:    exportRelocalizationMap
 * Signature: (Ljava/lang/String;)V
 */
JNIEXPORT void JNICALL
Java_org_robotroopers_wrapper_T265Camera_exportRelocalizationMap(JNIEnv *,
jobject,
jstring);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_org_robotroopers_wrapper_T265Camera_free(JNIEnv *,
jobject);
 ...
 * Signature: (FFFD)V
 */
JNIEXPORT void JNICALL Java_org_robotroopers_wrapper_T265Camera_setOdometryInfo(
 ...
 * Signature: (IFF)V
 */
JNIEXPORT void JNICALL Java_org_robotroopers_wrapper_T265Camera_sendOdometryRaw(
...
JNIEXPORT jlong JNICALL
        Java_org_robotroopers_wrapper_T265Camera_newCamera(JNIEnv *, jobject, jstring);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_org_robotroopers_wrapper_T265Camera_cleanup(JNIEnv *,
jclass);
